...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 bg-[#15182b]">
      <section>
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
          <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
            ...
            <h1 className="text-gray-900 dark:text-white text-3xl md:text-5xl font-extrabold mb-2">Buat Program Kerjamu Sekarang</h1>
            <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            <Link
              href="/dashboard"
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
              ...
              <h2 className="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Mudah Digunakan</h2>
              <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Asperiores sequi recusandae commodi nam architecto tenetur consequatur blanditiis esse ipsam? Vero fuga laudantium consectetur soluta eos.
              </p>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
              ...
              <h2 className="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Kesederhanaan</h2>
              <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Asperiores sequi recusandae commodi nam architecto tenetur consequatur blanditiis esse ipsam? Vero fuga laudantium consectetur soluta eos.
              </p>
              <a href="#" className="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">
